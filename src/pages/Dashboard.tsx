    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ flex: '0 1 80%', minWidth: 220, maxWidth: '80%' }}>
          <div style={{ display: 'flex', alignItems: 'center', fontWeight: 700, fontSize: 30, color: '#0066e6', marginBottom: 12, wordBreak: 'break-word' }}>
            ...
            >
              ...
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#2563eb" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" style={{ display: 'block' }}>
                <path d="M12 20h9" />
      ...
      <div style={{ display: 'flex', gap: 24, marginBottom: 32, width: '100%' }}>
        ...
        <div style={{ flex: 1, display: 'flex', minHeight: 90, borderRadius: 8, boxShadow: '0 1px 4px #e0e0e0', background: 'linear-gradient(90deg, #2563eb 0%, #1e40af 100%)', overflow: 'hidden' }}>
          ...
          <div style={{ flex: '1 1 80%', background: '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '18px 0 18px 18px' }}>
            <div style={{ color: '#1e88e5', fontWeight: 600, fontSize: 13, letterSpacing: 1 }}>TOTAL POSTS</div>
        ...
        <div style={{ flex: 1, display: 'flex', minHeight: 90, borderRadius: 8, boxShadow: '0 1px 4px #e0e0e0', background: 'linear-gradient(90deg, #1e88e5 0%, #2563eb 100%)', overflow: 'hidden' }}>
          ...
          <div style={{ flex: '1 1 80%', background: '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '18px 0 18px 18px' }}>
            <div style={{ color: '#1e88e5', fontWeight: 600, fontSize: 13, letterSpacing: 1 }}>PUBLISHED</div>
        ...
        <div style={{ flex: 1, display: 'flex', minHeight: 90, borderRadius: 8, boxShadow: '0 1px 4px #e0e0e0', background: 'linear-gradient(90deg, #22c55e 0%, #15803d 100%)', overflow: 'hidden' }}>
          ...
          <div style={{ flex: '1 1 80%', background: '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '18px 0 18px 18px' }}>
            <div style={{ color: '#1e88e5', fontWeight: 600, fontSize: 13, letterSpacing: 1 }}>DRAFTS</div>
        ...
        <div style={{ flex: 1, display: 'flex', minHeight: 90, borderRadius: 8, boxShadow: '0 1px 4px #e0e0e0', background: 'linear-gradient(90deg, #f59e42 0%, #e65100 100%)', overflow: 'hidden' }}>
          ...
          <div style={{ flex: '1 1 80%', background: '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '18px 0 18px 18px' }}>
            <div style={{ color: '#1e88e5', fontWeight: 600, fontSize: 13, letterSpacing: 1 }}>SCHEDULED</div>
      ...
      <Card title={<span style={{ fontWeight: 600 }}>Recent Posts</span>} loading={loading} variant="borderless" style={{ marginTop: 24, boxShadow: '0 1px 4px #e0e0e0', width: '100%' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 18, padding: '8px 0' }}>
          {(recentPosts.length > 0 ? recentPosts : [{ id: 0, title: 'Demo Post', slug: '', content: '', publishedAt: '' }]).map((item, idx) => (
            <div
              key={item.id || idx}
              style={{
                display: 'flex',
                alignItems: 'center',
                background: 'linear-gradient(90deg, #e0edfa 0%, #fff 100%)',
                borderRadius: 12,
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontWeight: 600, fontSize: 17, color: '#2563eb', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{item.title}</div>
