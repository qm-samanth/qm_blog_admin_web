          ...
          >
            <Row gutter={36}>
              <Col xs={24} md={8} style={{ textAlign: 'center' }}>
                ...
                <Form.Item name="profile_pic_url" label={<span style={{ fontWeight: 500 }}>Profile Picture URL</span>} style={{ textAlign: 'left', marginBottom: 16 }}>
                  <Input placeholder="Enter image URL" style={{ borderRadius: 8, background: '#f8fafc', border: '1px solid #e2e8f0' }} />
                </Form.Item>
                <div style={{ textAlign: 'left', padding: '12px', background: '#f8fafc', borderRadius: 8, marginBottom: 16, boxShadow: '0 1px 4px 0 rgba(0,0,0,0.03)' }}>
              ...
              <Col xs={24} md={16}>
                <Form.Item name="name" label={<span style={{ fontWeight: 500 }}>Name</span>} rules={[{ required: true, message: 'Please enter your name' }]}> 
